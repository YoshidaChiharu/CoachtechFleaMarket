...
Route::middleware('verified', 'auth')->group(function () {
    ...
    Route::get('/purchase/address/register/{item_id}', [ShipAddressController::class, 'create'])->name('purchase.address.register');
    Route::post('/purchase/address/register/{item_id}', [ShipAddressController::class, 'store']);

    Route::get('/purchase/address/edit/{item_id}', [ShipAddressController::class, 'edit'])->name('purchase.address.edit');
    Route::post('/purchase/address/edit/{item_id}', [ShipAddressController::class, 'update']);
    Route::delete('/purchase/address/edit/{item_id}', [ShipAddressController::class, 'destroy']);
